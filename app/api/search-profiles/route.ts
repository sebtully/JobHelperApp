import { EmploymentType, Seniority, WorkplaceType } from "@/generated/prisma/client";
...
const searchProfileSchema = z.object({
  ...
  seniority: z.array(z.nativeEnum(Seniority)).default([]),
  employmentTypes: z.array(z.nativeEnum(EmploymentType)).default([]),
  workplaceTypes: z.array(z.nativeEnum(WorkplaceType)).default([]),
